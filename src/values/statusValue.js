...
export const HTTP_PROCESSING = 102; // RFC251
...
export const HTTP_MULTI_STATUS = 207; // RFC491
export const HTTP_ALREADY_REPORTED = 208; // RFC584
export const HTTP_IM_USED = 226; // RFC322
...
export const HTTP_PERMANENTLY_REDIRECT = 308; // RFC723
...
export const HTTP_I_AM_A_TEAPOT = 418; // RFC232
export const HTTP_MISDIRECTED_REQUEST = 421; // RFC754
export const HTTP_UNPROCESSABLE_ENTITY = 422; // RFC491
export const HTTP_LOCKED = 423; // RFC491
export const HTTP_FAILED_DEPENDENCY = 424; // RFC491
export const HTTP_RESERVED_FOR_WEBDAV_ADVANCED_COLLECTIONS_EXPIRED_PROPOSAL = 425; // RFC281
export const HTTP_UPGRADE_REQUIRED = 426; // RFC281
export const HTTP_PRECONDITION_REQUIRED = 428; // RFC658
export const HTTP_TOO_MANY_REQUESTS = 429; // RFC658
export const HTTP_REQUEST_HEADER_FIELDS_TOO_LARGE = 431; // RFC658
...
export const HTTP_VARIANT_ALSO_NEGOTIATES_EXPERIMENTAL = 506; // RFC229
export const HTTP_INSUFFICIENT_STORAGE = 507; // RFC491
export const HTTP_LOOP_DETECTED = 508; // RFC584
export const HTTP_NOT_EXTENDED = 510; // RFC277;
